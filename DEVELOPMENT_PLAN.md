...
- [ ] 9.3 Многоязычность (i18n)
- [ ] 9.4 Сканирование штрих-кодов
...
## 📱 Реализованные экраны (16 экранов)
...
├── QuickIntake/             # ✅ Быстрый прием лекарства
...
- [x] Таблица `medicines` - лекарства
- [x] Таблица `medicine_stock` - запасы лекарств
- [x] Таблица `medicine_usage` - история приема
...
- [x] NotificationSettings (настройки)
